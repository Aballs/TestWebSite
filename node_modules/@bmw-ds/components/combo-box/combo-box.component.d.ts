...
export declare class ComboBoxComponent implements OnInit, AfterContentInit, AfterViewInit, ControlValueAccessor, OnChanges, OnDestroy {
    ...
    click(): void;
    inputTouched(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ComboBoxComponent, [{ optional: true; self: true; }, null, null]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ComboBoxComponent, "bmw-combo-box", never, { "noResultsPlaceholder": "noResultsPlaceholder"; "disabled": "disabled"; "tabIndex": "tabIndex"; "required": "required"; "clearable": "clearable"; "selectedOptionsText": "selectedOptionsText"; "value": "value"; "type": "type"; "id": "id"; "placeholder": "placeholder"; "customFilter": "customFilter"; "textInsteadOfTags": "textInsteadOfTags"; }, { "changeEvent": "changeEvent"; "open": "open"; }, ["_label", "items"], ["bmw-label", "bmw-error-message"]>;
}

//# sourceMappingURL=combo-box.component.d.ts.map